...
// $curl=new CURL();
// // $curl->SSL_VERIFYHOST_VERIFYPEER();
// $curl->setUrl("https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid=wx05b7a33743a5d2a5&secret=60fa338cdbfb5d3e6187cf8dd7b8d6af");
// echo $curl->exec();